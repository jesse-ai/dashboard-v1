<template>
  <BigContainer>
    <div class="mx-auto prose prose-indigo prose">
      <UCard>
            ...
            <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
              <div class="text-center">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                  ...
                  <NuxtLink href="mailto:support@jesse.trade"
                            class="text-sm font-semibold text-gray-900 no-underline hover:underline">
