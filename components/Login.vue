  ...
  <section v-if="open"
    ...
    <div class="text-center">
      <div class="w-full text-center">
        ...
        <img class="animate-bounce h-32 w-auto mx-auto hidden dark:block" src="@/assets/imgs/logo-dark.svg"
             alt="Jesse Logo">
      </div>
      ...
      <div>
        <UForm :state="form" class="flex items-center justify-center" @submit="login">
          <UFormGroup name="password">
            <UInput v-model="form.password" placeholder="password" icon="i-heroicons-lock-closed" size="xl"
                    type="password"/>
          </UFormGroup>

          <UButton icon="i-heroicons-arrow-long-right" type="submit" class="ml-2" size="xl" color="primary" square
                   variant="solid"/>
        </UForm>
      </div>
    </div>
