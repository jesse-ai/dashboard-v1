  ...
  <div id="make-strategy-modal" class="w-full select-none">
    ...
    <UForm :state="form" class="space-y-4" @submit="create">
      ...
      <div class="flex justify-end">
        <UButton id="make-strategy-cancel-button" color="gray" variant="link" class="mr-8" label="Cancel"
                 @click="makeStrategy = false"/>

        <UButton id="make-strategy-submit-button" type="submit" class="w-48 flex justify-center " label="Create"
