    ...
    <div id="make-strategy-modal" class="w-full select-none">
        ...
        <UForm :state="form" class="space-y-4" @submit="create">
            ...
            <div v-if="form.name.length">
                ...
                <pre class="mt-2 text-sm whitespace-pre-line px-6 py-3 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 dark:border-gray-800 border border-gray-200 select-text">
