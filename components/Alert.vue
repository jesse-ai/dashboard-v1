        ...
        <div class="flex">
            ...
            <div class="ml-auto pl-3">
                <div class="-mx-1.5 -my-1.5">
                    <button type="button" class="inline-flex rounded-md p-1.5 focus:outline-none" :class="textColor" @click="close">
...
import { CheckCircleIcon, XMarkIcon, ExclamationTriangleIcon, ExclamationCircleIcon } from '@heroicons/vue/24/solid'
