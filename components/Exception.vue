  ...
  <SlideOver v-model="exceptionReport" title="Report">
    <div v-if="alert.message" class="mb-4">
      <UAlert
        ...
        :title="alert.message" :close-button="{ icon: 'i-heroicons-x-mark-20-solid', color: 'white', variant: 'link' }"
        @close="alert.message = ''" />
    </div>
  ...
  <div class="rounded-md bg-red-50 p-4 my-4 select-text">
    <div class="flex">
      ...
      <div class="ml-3 overflow-hidden">
        ...
        <pre
          v-if="content" class="mt-2 text-sm text-red-700 whitespace-pre-line px-6 py-6 rounded-md border-2 border-dashed border-red-200"
          v-html="content" />
      </div>
    </div>
