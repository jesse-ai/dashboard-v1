...
// ==================== Backtest Tab ====================
interface BacktestCandlesInfoEvent {
    duration: string;
...
interface BacktestRoutesInfoEvent {
    exchange: string,
    symbol: string,
    timeframe: string,
    strategy_name: string
...
interface BacktestMetricsEvent {
    total: number;
...
interface BacktestEquityCurveEvent {
    timestamp: number;
    balance: number;
}

interface BacktestRouteInfo {
    value: string;
    style: string;
}
